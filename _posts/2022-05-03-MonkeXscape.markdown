...
banner:
  ...
  volume: 0.8
  start_at: 8.5
  image: "/assets/images/monkeXscape/monkeXscape.jpg"
  opacity: 0.618
  background: "#000"
  height: "100vh"
  min_height: "38vh"
...
### Language
**C** 
We were restricted to using C

## Libraries Used
- [CProcessing](https://github.com/DigiPen-Faculty/CProcessing/wiki)
...
Our game is a 2D side scrolling platformer with different difficulty levels implemented. 
All the controls can be found under the Settings page.
Take note that the game level will restart when the player falls off the platform.
Remember that player's can jump and hook onto the platform to prevent themselves from falling off the platform/enemy attack.
Do note that there will be an alert zone where the player will be detected. When the enemy detects the player, bullets will be fired.
Banana's collected will be counted into the score.
