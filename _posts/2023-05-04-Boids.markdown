...
banner:
  ...
  volume: 0.8
  start_at: 8.5
  image: "/assets/images/Boids/boids.gif"
  opacity: 0.618
  background: "#000"
  height: "100vh"
  min_height: "38vh"
...
<div class="full-width-iframe-container">
    <div class="responsive-iframe">
        <iframe src="/assets/iframe/Boids/boids.html" width="100%" height="500px" frameborder="0" allowfullscreen></iframe>
    </div>
</div>
    
<script src="/assets/js/Boids/boids.js"></script>
<script src="/assets/js/Boids/predator.js"></script>
<script src="/assets/js/Boids/sketch.js"></script>
